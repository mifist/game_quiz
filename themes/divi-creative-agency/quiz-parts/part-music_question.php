...
<section id="quiz_<?php echo $game_question_steps; ?>"
         class="quiz-step music-quiz <?php
	...
	<div class="quiz-step__controls">
		<a class="btn quiz-step__media-play" href="#">
			<span class="name"><?php echo __('Lancer le son', ca_textdomain); ?></span>
			<span class="icon"></span>
		</a>
		<a class="btn quiz-step__media-pause" href="#">
			<span class="name"><?php echo __('Pause', ca_textdomain); ?></span>
			<span class="icon"></span>
		</a>
		
		<div id="cta_modal_audio_play_<?php echo $game_question_steps; ?>" class="media-data">
			<span class="media-audio-correct" data-correct="<?php echo $correct_media_upload ?: $correct_media_url; ?>"></span>
			<?php if( $question_media_upload ) : ?>
				<audio class="media-audio" >
					<source class="media-audio-source" src="<?php echo $question_media_upload; ?>" type="audio/mp3">
				</audio>
			<?php else : ?>
				<audio class="media-audio">
					<source class="media-audio-source" src="<?php echo $question_media_url; ?>" type="audio/mp3">
				</audio>
			<?php endif; ?>
		</div>
	</div>
		...
		<div class="quiz-step__questions">
			...
			<div class="quiz-step__content">
				<div class="quiz-step__meta">
					<div class="quiz-step__media-type"><?php echo __('Musique', ca_textdomain); ?></div>
