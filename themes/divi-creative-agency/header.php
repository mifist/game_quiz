...
<?php
	...
	$preload_logo = et_get_option( 'divi_preload_logo' );
	// $def_preload = $template_directory_uri_child.'/assets/images/Logo_GS_2019_minifined.svg' ;
	// $preload_logo = et_get_option( 'divi_preload_logo' ) ? et_get_option( 'divi_preload_logo' ) : $def_preload;
?>
...
<body <?php body_class(); ?>>
<!-- data-preloader_img="<?php echo $preload_logo; ?>" -->
...
?>
	...
	<?php ob_start();
	// global
	$show_right_menu = get_theme_mod( 'show_right_menu' ); ?>
		<header id="main-header" class="ca-main-header " data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height',	'66' ) ); ?>">
			<div class="container clearfix et_menu_container <?php echo ($show_right_menu===false?'ca-header-no-right':''); ?>">
				<?php get_template_part('template-parts/header', 'right_primary'); ?>
			...
			<?php
				...
				ob_start();
			?>
				<div class="logo_container" style="max-height: <?php echo esc_attr( et_get_option( 'logo_height', '54' ) );
				?>px;">
