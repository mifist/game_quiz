...
$options = array (
	...
	array( "name" => esc_html__( "Logo for Preload", $themename ),
	       "id" => $shortname . "_preload_logo",
	       "type" => "upload",
	       "button_text" => esc_html__( "Set As Logo", $themename ),
	       "std" => "",
	       "desc" => esc_html__( "If you would like to use your own custom preload logo image click the Upload Image button.", $themename )
	),
